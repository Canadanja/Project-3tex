...
\end{equation}
Hence one of the electrons has spin 1/2 and the other one has spin -1/2. Despite this they are indistinguishable, which means both states are possible.\\
Regarding the wave function we will now make an seperational ansatz for its simplification:
\begin{align}
...
According to this ansatz we can focus on the position-based part of the wave function for the following analysis of two electrons.\\
